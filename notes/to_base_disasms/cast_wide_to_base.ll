define linkonce_odr dso_local %struct.WideRoot* @_Z13__myrtti_castI8WideRootP9WideFinalEPT_T0_(%struct.WideFinal* %0) local_unnamed_addr #4 comdat personality i32 (...)* @__gxx_personality_v0 {
  %2 = alloca %struct.WideRoot*, align 8
  %3 = bitcast %struct.WideRoot** %2 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %3) #17
  %4 = icmp eq %struct.WideFinal* %0, null
  br i1 %4, label %14, label %5

5:                                                ; preds = %1
  %6 = bitcast %struct.WideFinal* %0 to i8**
  %7 = load i8*, i8** %6, align 8, !tbaa !10
  %8 = getelementptr i8, i8* %7, i64 -24
  %9 = bitcast i8* %8 to i64*
  %10 = load i64, i64* %9, align 8
  %11 = bitcast %struct.WideFinal* %0 to i8*
...
14:                                               ; preds = %5, %1
  ...
  %16 = tail call %"struct.myrtti::ClassInfo"* @_ZN8WideRoot4infoEv()
...
53:                                               ; preds = %42, %36, %14, %48, %51
  store %struct.WideRoot* null, %struct.WideRoot** %2, align 8, !tbaa !19
  br label %60
...
54:                                               ; preds = %48, %51
  ...
  %57 = bitcast i8* %56 to %struct.WideRoot**
  %58 = load %struct.WideRoot*, %struct.WideRoot** %57, align 8, !tbaa !21
  store %struct.WideRoot* %58, %struct.WideRoot** %2, align 8, !tbaa !19
  %59 = icmp eq %struct.WideRoot* %58, null
...
61:                                               ; preds = %54
  call void asm sideeffect "", "=*r|m,0,~{memory},~{dirflag},~{fpsr},~{flags}"(%struct.WideRoot** nonnull %2, %struct.WideRoot* nonnull %58) #17, !srcloc !23
  %62 = load %struct.WideRoot*, %struct.WideRoot** %2, align 8, !tbaa !19
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %3) #17
  ret %struct.WideRoot* %62
}