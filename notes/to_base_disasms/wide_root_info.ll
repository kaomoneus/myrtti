define linkonce_odr dso_local %"struct.myrtti::ClassInfo"* @_ZN8WideRoot4infoEv() local_unnamed_addr #2 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %1 = alloca %"struct.std::array", align 8
  %2 = load atomic i8, i8* bitcast (i64* @_ZGVZN8WideRoot4infoEvE1v to i8*) acquire, align 8
  %3 = icmp eq i8 %2, 0
  br i1 %3, label %4, label %29, !prof !6

4:                                                ; preds = %0
  %5 = tail call i32 @__cxa_guard_acquire(i64* nonnull @_ZGVZN8WideRoot4infoEvE1v) #17
  %6 = icmp eq i32 %5, 0
...
18:                                               ; preds = %15, %11, %7
  ...
  store i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.47, i64 0, i64 0), i8** getelementptr inbounds (%"struct.myrtti::ClassInfo", %"struct.myrtti::ClassInfo"* @_ZZN8WideRoot4infoEvE1v, i64 0, i32 0), align 8, !tbaa !26
  store i64 -2120594854850669430, i64* getelementptr inbounds (%"struct.myrtti::ClassInfo", %"struct.myrtti::ClassInfo"* @_ZZN8WideRoot4infoEvE1v, i64 0, i32 1, i32 0), align 8, !tbaa.struct !29
...
27:                                               ; preds = %25, %22, %18
  invoke void @_ZN6myrtti9Hierarchy3addISt5arrayIPKNS_9ClassInfoELm1EEEEvS5_RKT_(%"struct.myrtti::Hierarchy"* nonnull @_ZZN6myrtti9Hierarchy8instanceEvE1h, %"struct.myrtti::ClassInfo"* nonnull @_ZZN8WideRoot4infoEvE1v, %"struct.std::array"* nonnull dereferenceable(8) %1)
          to label %28 unwind label %30

28:                                               ; preds = %27
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %8) #17
  call void @__cxa_guard_release(i64* nonnull @_ZGVZN8WideRoot4infoEvE1v) #17
  br label %29

29:                                               ; preds = %4, %28, %0
  ret %"struct.myrtti::ClassInfo"* @_ZZN8WideRoot4infoEvE1v
...
32:                                               ; preds = %16, %30
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %8) #17
  call void @__cxa_guard_abort(i64* nonnull @_ZGVZN8WideRoot4infoEvE1v) #17
  resume { i8*, i32 } %33
}